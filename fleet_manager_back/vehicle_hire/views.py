...
from .models import (VehicleHire,
VehicleHireRentalCollectionDetails,
VehicleHireRentalRevenue,
VehicleHireRentalStatus,
VehicleHireCostCenter,
VehicleHireReason, 
VehicleHireStatus,
VehicleHireRentalDetailHiringDivision, 
VehicleHireRentalInvoicesTo, 
VehicleHireRentalPaymentRecievedBy, 
VehicleHireRentalPaymentStatus,VehicleHireRentalRevenueInvoicedBy,
