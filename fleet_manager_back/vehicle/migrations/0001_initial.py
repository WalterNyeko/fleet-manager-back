# Generated by Django 2.2.7 on 2019-11-30 07:41
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('vehicle_deductability', '0001_initial'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicle_deductability', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vehicle_deductability.VehicleDeductability')),
                ('vehicle_fuel_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vehicle_fuel_type.VehicleFuelType')),
                ('vehicle_gear_box', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vehicle_gear_box.VehicleGearBox')),
