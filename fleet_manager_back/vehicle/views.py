...
from .models import VehicleInsuranceCompany, Vehicle,VehicleClient, VehicleBodyType, VehicleConventionType, VehicleCostCenter, VehicleCompanyCode, VehicleCountry, VehicleCounty, VehicleCurrencyCodes,VehicleDeductability, VehicleFuelType, VehicleGearBox, VehicleInPull, VehicleLocationCode,VehicleMakeCode, VehicleModelCode, VehicleReturnedWorkshop, VehicleStatus, VehicleType,VehicleTyre
from .serializers import VehicleInsuranceCompanySerializer, VehicleSerializer, VehicleClientSerializer, VehicleBodyTypeSerializer, VehicleCompanyCodeSerializer, VehicleConventionTypeSerializer, VehicleCostCenterSerializer, VehicleCountrySerializer, VehicleCountySerializer, VehicleCurrencyCodesSerializer, VehicleDeductabilitySerializer, VehicleFuelTypeSerializer, VehicleGearBoxSerializer, VehicleInPullSerializer, VehicleLocationCodeSerializer, VehicleMakeCodeSerializer, VehicleModelCodeSerializer, VehicleReturnedWorkshopSerializer, VehicleStatusSerializer, VehicleTypeSerializer, VehicleTyreSerializer
